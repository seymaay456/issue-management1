...
public interface ProjectService {
    ...
    Project save (Project project); //bir method issue kaydını parametre aldı. o kaydettiği kaydın son hali geri döndü.
    Project getById (Long id); //getById için Id vericem bu methoda, bbu methodda bana bu idli kaydı vericek.
