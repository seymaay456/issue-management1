...
public interface UserService {
    ...
    User save (User user); //bir method issue kaydını parametre aldı. o kaydettiği kaydın son hali geri döndü.
    User getById (Long id); //getById için Id vericem bu methoda, bbu methodda bana bu idli kaydı vericek.

    org.springframework.data.domain.Page<User>  getAllPageable(Pageable pageable);
