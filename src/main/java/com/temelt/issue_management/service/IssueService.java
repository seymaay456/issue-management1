...
public interface IssueService {
    ...
    //issue nesnesini apı üzerinden clientlarla konuşmasını istemiyorum. Aray DTO nesneleri oluşturcaz.
    IssueDto save (IssueDto issue); //bir method issue kaydını parametre aldı. o kaydettiği kaydın son hali geri döndü.
   //save işlevi yapılırken, servisime dtosu verilsin serviste geriye dto döndürsün. ama servis kendisi içerisinde entity ile çalışsın.

    IssueDto getById (Long id); //getById için Id vericem bu methoda, bbu methodda bana bu idli kaydı vericek.
